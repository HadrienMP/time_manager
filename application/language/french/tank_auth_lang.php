...
$lang['auth_incorrect_email_or_username'] = 'Login ou courriel inexistant';
...
$lang['auth_message_registration_completed_2'] = 'Inscription complétée.';
$lang['auth_message_activation_email_sent'] = 'Un courriel d\'activation a été envoyé à %s. Suivez les instructions du courriel pour activer votre compte.';
$lang['auth_message_activation_completed'] = 'Votre compte a été activé avec succès.';
$lang['auth_message_activation_failed'] = 'Le code d\'activation saisie est incorrect ou expiré.';
$lang['auth_message_password_changed'] = 'Votre mot de passe a été changé avec succès.';
$lang['auth_message_new_password_sent'] = 'Un courriel contenant les instructions de création d\'un nouveau mot de passe vous a été envoyé.';
$lang['auth_message_new_password_activated'] = 'Votre mode de passe a été réintialisé avec succès.';
$lang['auth_message_new_password_failed'] = 'Votre clef d\'activation est incorrecte ou expirée. Vérifiez votre courriel à nouveau.';
...
$lang['auth_subject_activate'] = 'Bienvenue à %s!';
$lang['auth_subject_forgot_password'] = 'Vous avez oublié votre mot de passe sur %s?';
